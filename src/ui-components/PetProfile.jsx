...
export default function PetProfile(props) {
  ...
  const buttonThreeEightFiveOneEightFiveFourOnClick = async () => {
  ...
  const melindaMarcusOnClick = () => {
    setImageSrc(
      "https://images.fineartamerica.com/images/artworkimages/mediumlarge/2/chocolate-labrador-retriever-sergey-ryumin.jpg"
    );
  };
  useEffect(() => {
  ...
  return (
    <Flex
      ...
      backgroundColor="rgba(112,185,237,1)"
    ...
    >
      <Button
        ...
        children="Delete"
        onClick={() => {
          buttonThreeEightFiveOneEightFiveFourOnClick();
        }}
        {...getOverrideProps(overrides, "Button3851854")}
      ></Button>
      <Image
        width="160px"
        height="160px"
      ...
      >
        <Button
          ...
          top="0px"
          left="0px"
          backgroundColor="rgba(49,150,138,1)"
          size="large"
          isDisabled={false}
          variation="primary"
          children="Profile"
        ...
        <Button
          ...
          variation="primary"
          children="Update"
          {...getOverrideProps(overrides, "Button3851537")}
        ></Button>
      </View>
      <Flex
        gap="16px"
